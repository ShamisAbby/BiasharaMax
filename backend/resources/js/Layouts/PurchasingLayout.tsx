...
const TABS = [
    { name: 'purchasing.dashboard', label: 'Dashboard' },
    { name: 'purchasing.orders.index', label: 'Purchase Orders' },
    { name: 'purchasing.goods-received.index', label: 'Goods Received' },
