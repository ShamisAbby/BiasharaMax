...
class RegistrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->seed([PermissionSeeder::class, SubscriptionPlanSeeder::class, BusinessTypeSeeder::class]);
    }
    ...
    public function test_registering_creates_owner_business_roles_and_trial_subscription(): void
    {
        ...
        $this->assertSame(11, Role::query()->where('business_id', $business->getKey())->count());
