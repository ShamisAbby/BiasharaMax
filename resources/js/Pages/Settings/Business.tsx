...
const BUSINESS_TYPES = [
    'retail', 'supermarket', 'restaurant', 'pharmacy', 'hardware',
    'electronics', 'fashion', 'beauty', 'wholesale', 'service', 'other',
];
        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    <Card title="Business profile" description="Update your business information.">
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="grid gap-4 sm:grid-cols-3">
                                <div>
                                    <InputLabel htmlFor="country" value="Country code" />
                                    <TextInput
                                        id="country"
